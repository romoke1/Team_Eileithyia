...
<section>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="offset-3 col-lg-5 col-md-5 col-sm-6 col-xs-5 instructor-signupForm" style="margin-top: 6%; margin-bottom: 5%;">
                <h2 class="text-center text-light" style="margin-bottom: 2%">Teacher's Signup</h2>
