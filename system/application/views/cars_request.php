<!-- Contents Starts Here-->
		<section class="b-pageHeader">
			<div class="container">
				<h1 class="wow zoomInLeft" data-wow-delay="0.7s">Request a Specific Car</h1>
		...
		<div class="b-breadCumbs s-shadow">
			<div class="container">
				<a href="home" class="b-breadCumbs__page">Home</a><span class="fa fa-angle-right"></span><a href="about" class="b-breadCumbs__page m-active">About Us</a>
			</div>
		</div><!--b-breadCumbs-->
		...
		<section class="b-best">
			<div class="container">
				<div class="row">
					...
					<div class="col-sm-6 col-xs-12">
						<img class="img-responsive center-block wow zoomInUp" data-wow-delay="0.5s" alt="best" src="<?= base_url()?>/media/about/best.jpg" />
					</div>
				</div>
			</div>
		</section><!--b-best-->
				...
				<div class="row">
					<div class="col-sm-4 col-xs-12">
						<div class="b-world__item wow zoomInLeft" data-wow-delay="0.5s">
							<img class="img-responsive" src="<?= base_url()?>/media/370x200/wolks.jpg" alt="wolks" />
					...
					<div class="col-sm-4 col-xs-12">
						<div class="b-world__item wow zoomInUp" data-wow-delay="0.5s">
							<img class="img-responsive"  src="<?= base_url()?>/media/370x200/mazda.jpg" alt="mazda" />
							<div class="b-world__item-val">
					...
					<div class="col-sm-4 col-xs-12">
						<div class="b-world__item wow zoomInRight" data-wow-delay="0.5s">
							<img class="img-responsive"  src="<?= base_url()?>/media/370x200/chevrolet.jpg" alt="chevrolet" />
							<div class="b-world__item-val">
			...
			<div class="container">
				...
				<div id="carousel-small" class="owl-carousel enable-owl-carousel" data-items="4" data-navigation="true" data-auto-play="true" data-stop-on-hover="true" data-items-desktop="4" data-items-desktop-small="3" data-items-tablet="2" data-items-tablet-small="2">
					<div>
						<div class="b-personal__worker wow zoomInUp" data-wow-delay="0.5s">
							<div class="b-personal__worker-img">
								<img src="<?= base_url()?>/media/persons/jason.jpg" class="img-responsive" alt="jason"/>
					...
					<div>
						<div class="b-personal__worker wow zoomInUp" data-wow-delay="0.5s">
							<div class="b-personal__worker-img">
								<img src="<?= base_url()?>/media/persons/paul.jpg" class="img-responsive" alt="paul"/>
								<div class="b-personal__worker-img-social">
									<div class="b-personal__worker-img-social-main">
										<a href="#"><span class="fa fa-facebook-square"></span></a>
										<a href="#"><span class="fa fa-twitter-square"></span></a>
					...
					<div>
						<div class="b-personal__worker wow zoomInUp" data-wow-delay="0.5s">
							<div class="b-personal__worker-img">
								<img src="<?= base_url()?>/media/persons/peter.jpg" class="img-responsive" alt="peter"/>
								<div class="b-personal__worker-img-social">
									<div class="b-personal__worker-img-social-main">
										<a href="#"><span class="fa fa-facebook-square"></span></a>
										<a href="#"><span class="fa fa-twitter-square"></span></a>
					...
					<div>
						<div class="b-personal__worker wow zoomInUp" data-wow-delay="0.5s">
							<div class="b-personal__worker-img">
								<img src="<?= base_url()?>/media/persons/maria.jpg" class="img-responsive" alt="maria"/>
								<div class="b-personal__worker-img-social">
									<div class="b-personal__worker-img-social-main">
										<a href="#"><span class="fa fa-facebook-square"></span></a>
										<a href="#"><span class="fa fa-twitter-square"></span></a>
