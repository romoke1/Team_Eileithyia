<section class="b-pageHeader">
            <div class="container">
                <h1 class=" wow zoomInLeft" data-wow-delay="0.5s">Reset Password</h1>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-6 col-lg-offset-3">
                        ...
                        New Password
                                <input type="text" required="" placeholder="New Password " value="" name="txtNewPass"  />
                                Repeat New Password
                                <input type="text" required="" placeholder="Repeat New Password " value="" name="txtNewPass2"  />
