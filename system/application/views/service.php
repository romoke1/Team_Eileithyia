<!-- Contents Starts Here-->
		...
		<div class="b-breadCumbs s-shadow">
			<div class="container wow zoomInUp" data-wow-delay="0.7s">
				<a href="home" class="b-breadCumbs__page">Home</a><span class="fa fa-angle-right"></span><a href="service" class="b-breadCumbs__page m-active">Service</a>
			</div>
		</div><!--b-breadCumbs-->
				...
				<div class="row">
						...
						<div class="b-article__main">
											...
											<div class="b-blog__posts-one-body-main wow zoomInUp" data-wow-delay="0.5s">
												<div class="b-blog__posts-one-body-main-img">
													<ul class="bxslider enable-bx-slider" data-pager-custom="#bx-pager" data-mode="fade" data-pager-slide="false" data-mode-pager="horizontal" data-pager-qty="0">
														<li><img class="img-responsive" src="<?= base_url()?>/media/750x300/blogBig1.jpg" alt="jaguar" /></li>
														<li><img class="img-responsive" src="<?= base_url()?>/media/750x300/blogBig2.jpg" alt="jaguar" /></li>
														<li><img class="img-responsive" src="<?= base_url()?>/media/750x300/blogBig3.jpg" alt="jaguar" /></li>
													</ul>
													<div class="b-blog__posts-one-body-main-img-small" id="bx-pager">
														<a href="#" data-slide-index="0"><img src="<?= base_url()?>/media/90x65/smallBlog1.jpg" alt="car" /></a>
														<a href="#" data-slide-index="1"><img src="<?= base_url()?>/media/90x65/smallBlog2.jpg" alt="car" /></a>
														<a href="#" data-slide-index="2"><img src="<?= base_url()?>/media/90x65/smallBlog3.jpg" alt="car" /></a>
													</div>
												</div>
											...
											<div class="b-blog__posts-one-body-why wow zoomInUp" data-wow-delay="0.5s">
												...
												<div class="row">
													<div class="col-sm-6 col-xs-12">
														<img src="<?= base_url()?>/media/articles/article.jpg" class="img-responsive"  alt="nissan"/>
													</div>
													<div class="col-sm-6 col-xs-12">
								...
								<div class="row">
									<div class="col-sm-6 col-xs-12">
										<div class="b-article__main-related-item wow zoomInUp" data-wow-delay="0.5s">
											<div class="row m-smallPadding">
												<div class="col-xs-4">
													<img class="center-block img-responsive" src="<?= base_url()?>/media/100x80/related1.jpg" alt="related" />       
												</div>
												<div class="col-xs-8">
									...
									<div class="col-sm-6 col-xs-12">
										<div class="b-article__main-related-item wow zoomInUp" data-wow-delay="0.5s">
											<div class="row m-smallPadding">
												<div class="col-xs-4">
													<img class="center-block img-responsive" src="<?= base_url()?>/media/100x80/related2.jpg" alt="related" />       
												</div>
												<div class="col-xs-8">
							...
							<div class="b-article__main-comments">
								...
								<div class="row">
									...
									<div class="col-xs-12">
										<div class="b-article__main-comments-one m-second wow zoomInUp" data-wow-delay="0.5s">
											<div class="b-article__main-comments-one-person">
					...
					<div class="col-md-3 col-xs-12">
						<aside class="b-blog__aside">
							<form class="b-blog__aside-search wow zoomInUp" data-wow-delay="0.5s" action="http://templines.rocks/" method="post">
								<div>
							...
							<div class="b-blog__aside-popular wow zoomInUp" data-wow-delay="0.5s">
								...
								<div class="b-blog__aside-popular-posts">
									<div class="b-blog__aside-popular-posts-one">
										<img class="img-responsive" src="<?= base_url()?>/media/270x150/mercBlog.png" alt="merc" />
									...
									<div class="b-blog__aside-popular-posts-one">
										<img class="img-responsive" src="<?= base_url()?>/media/270x150/outlander.png" alt="outlander" />
							...
							<div class="b-blog__aside-reviews wow zoomInUp" data-wow-delay="0.5s">
								...
								<div class="b-blog__aside-reviews-posts">
									<div class="b-blog__aside-reviews-posts-one">
										<div class="row m-smallPadding">
											<div class="col-xs-5">
												<img src="<?= base_url()?>/media/100x80/audiRev.jpg" alt="audi" class="img-responsive pull-right" />
											</div>
											<div class="col-xs-7">
									...
									<div class="b-blog__aside-reviews-posts-one">
										<div class="row m-smallPadding">
											<div class="col-xs-5">
												<img src="<?= base_url()?>/media/100x80/mercRev.jpg" alt="merc" class="img-responsive  pull-right" />
											</div>
											<div class="col-xs-7">
												<div class="b-blog__aside-reviews-posts-one-info">
									...
									<div class="b-blog__aside-reviews-posts-one">
										<div class="row m-smallPadding">
											<div class="col-xs-5">
												<img src="<?= base_url()?>/media/100x80/mazdaRev.jpg" alt="" class="img-responsive  pull-right" />
											</div>
											<div class="col-xs-7">
												<div class="b-blog__aside-reviews-posts-one-info">
							...
							<div class="b-blog__aside-archives wow zoomInUp" data-wow-delay="0.5s">
								<header class="s-lineDownLeft">
							...
							<div class="b-detail__main-aside-about-call wow zoomInUp" data-wow-delay="0.5s">
