  <?php 
    $dealer = $this->model_getvalues->getDetails("dealers", "email", $this->session->userdata('email'));
  ?>
  <!-- Main container -->
		...
		<div class="main-header row">
		  <div class="col-sm-6 col-xs-7">
			...
			<ul class="user-info pull-left">          
			  <li class="profile-info dropdown"><a data-toggle="dropdown" class="dropdown-toggle" href="#" aria-expanded="false"> <img width="44" class="img-circle avatar" alt="" src="images/man-3.jpg"><?= $dealer['fullname']?> <span class="caret"></span></a>
			  
				<!-- User action menu -->
				<ul class="dropdown-menu">
				  
                                    <li><a href="<?= base_url()?>"><i class="icon-user"></i>My profile</a></li>
                                    <li><a href="<?= base_url()?>"><i class="icon-cog"></i>Account settings</a></li>
				  <li class="divider"></li>
                                  <li><a href="<?= base_url()?>dealers/logout"><i class="icon-logout"></i>Logout</a></li>
				</ul>
				<!-- /user action menu -->
			  </li>
			</ul>
