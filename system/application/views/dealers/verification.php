        ...
        <div class="login-content">
            ...
            <?= form_open() ?> 
                <div class="text-center">
                    ...
                    <p style="color: yellowgreen">Kindly enter the verification code that was send to your phone or email</p>
                </div>
                <div class="form-group">
                    <input type="text" name="txtVerify" placeholder="Enter Verification Code here" class="form-control" required="">
                </div>
                <div class="form-group">
