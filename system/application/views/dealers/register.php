	...
	<div class="login-content">
		<h2>Please fill in your details</h2>
			...
			<div class="form-group">
                            <input type="text" value="<?= set_value('txtFullname')?>" name="txtFullname" placeholder="Full Name" class="form-control" required="">
			</div>   
			
			<div class="form-group">
                            <input type="text" value="<?= set_value('txtComp')?>" name="txtComp" placeholder="Company Name" class="form-control" required="">
			</div>   
			<div class="form-group">
                            <input type="text" value="<?= set_value('txtCompAddr')?>" name="txtCompAddr" placeholder="Company Address" class="form-control" required="">
			</div>   
			<div class="form-group">
                            <input type="number" value="<?= set_value('txtPhone')?>" name="txtPhone" placeholder="Phone" class="form-control" required="">
			</div>   
			<div class="form-group">
                            <input type="email" value="<?= set_value('txtEmail')?>" name="txtEmail" placeholder="Email" class="form-control" required="">
			</div>                     
			<div class="form-group">
                            <input type="text" value="<?= set_value('txtCity')?>" name="txtCity" placeholder="City" class="form-control" required="">
			</div>                     
			<div class="form-group">
                            <input type="password" name="txtPass" placeholder="Password" class="form-control" required="">
			</div>
			<div class="form-group">
                            <input type="password" name="txtConPass" placeholder="Confirm Password" class="form-control" required="">
			</div>
			<div class="form-group form-action">
				<button class="btn btn-primary btn-block">Sign up</button>
			</div>
                <p class="text-center">Already have an account? <a href="<?= base_url()?>signin">Sign in</a></p>                        
		<?= form_close()?>
	</div>
</div>
<!--Load JQuery-->
