        ...
        <div class="row">
            <div class="col-lg-6 col-xs-12">
                <div class="b-infoBar__compare wow zoomInUp" data-wow-delay="0.5s">
                    <strong>On Sail Cars</strong> are cheaper. They arrive faster than Buy Now Cars because they've been bought, but are little more expensive than Buy Now Cars <a href="<?= base_url() ?>cars/all">Click Here to read more...</a>
                </div>
            </div>
            <div class="col-lg-6 col-xs-12">
                                    ...
                                    <div class="b-items__cars-one-info">
                                        ...
                                        <div class="row s-noRightMargin">
                                            <div class="col-md-9 col-xs-12">
                                                <p>This car's Arrival date is <strong><?= $ead ?></strong>. Pay <strong> &#8358;<?= number_format($price); ?></strong> today to secure it..</p>
