    ...
    <div id="carousel" class="slide carousel carousel-fade">
        <div class="carousel-inner">
            <div class="item active">
                <img src="<?= base_url() ?>/media/main-slider/1.jpg" alt="sliderImg" />
                <div class="container">
                    <div class="carousel-caption b-slider__info">
                        <h3>TokunboCars.NG</h3>
                        <h2>Let's Plan Your Next Car</h2>
                        <p>Imagine owning a Tokunbo car for just N500,000. Welcome! </p>
                    </div>
                </div>
            </div>
        </div>
...
<section class="b-search">
    <div class="container">
        <form action="pages/cust" method="POST" class="b-search__main">
            <div class="b-search__main-title wow zoomInUp" data-wow-delay="0.3s" style="min-width: 200px">
                <a href="<?= base_url() ?>cars/buy_now"  style="color: #FFF; text-decoration: underline; min-width: 100px"><h2>BUY NOW</h2>
                    <span>Cheapest Cars</span></a>

            </div>

            <div class="b-search__main-title wow zoomInUp" data-wow-delay="0.3s" style="background-color: #00775E; color: #fff; min-width: 200px">
                <a href="<?= base_url() ?>cars/sail"  style="color: #FFF; text-decoration: underline; min-width: 100px"><h2>ON SAIL</h2>
                    <span>Cheaper Cars</span>
                </a>

            </div>

            <div class="b-search__main-title wow zoomInUp" data-wow-delay="0.3s" style="background-color: #08c; color: #FFF; min-width: 200px">
                <a href="<?= base_url() ?>cars/ground"  style="color: #FFF; text-decoration: underline; min-width: 100px"><h2>ON GROUND</h2>
                ...
                <div class="row">
                    <div class="col-xs-12 col-md-8">
                        <div class="m-firstSelects">
                            <div class="col-xs-4">
                                <select name="ddlMake" id="make_cat" onchange="fetchModels2()" >
                            ...
                            <div class="col-xs-4"  id="fetchmodel">
                                <select name="select2">
                        ...
                        <div class="m-secondSelects">
                            <div class="col-xs-4">
                                <select name="ddlRun" >
                                    <option value="" selected="">Run and Drive</option>
                            ...
                            <div class="col-xs-4">
                                <select name="ddlStatus" required="">
                                    <option value="" selected="">Car Status</option>
...
<section class="b-featured">
    <div class="container">
        <h2 class="s-title wow zoomInUp" data-wow-delay="0.3s">Recent Cars </h2>
        <div id="carousel-small" class="owl-carousel enable-owl-carousel" data-items="4" data-navigation="true" data-auto-play="true" data-stop-on-hover="true" data-items-desktop="4" data-items-desktop-small="4" data-items-tablet="3" data-items-tablet-small="2">
            <?php
            foreach ($list as $item) {

                $make = $this->model_getvalues->getDetails("make", "make_id", $item->make);
                $model = $this->model_getvalues->getDetails("model", "model_id", $item->model);

                $ead = date('jS M Y', strtotime("+45 days", (strtotime(date('Y-m-d')))));

                /* switch ($item->status) {
                  case 1:
                  $class = '<span class="m-premium">Buy Now</span>';
                  break;
                ...
                <div>
                    <div class="b-featured__item wow rotateIn" data-wow-delay="0.3s" data-wow-offset="150">
                        <a href="<?= base_url(); ?>cars/item/<?= $item->car_id; ?>">
                            <img src="<?= base_url() ?>upload/<?= $item->image_1; ?>" alt="mers" height="133" />
                        ...
                        <h5><a href="<?= base_url(); ?>cars/item/<?= $item->car_id; ?>"><?= $item->year . " " . $make['name'] . " " . $model['name']." ".$item->others ?></a></h5>
                        <div class="b-featured__item-count"><span class="fa fa-tachometer"></span><?= number_format($item->odometer, 0) ?> mi</div>
                        <div class="b-featured__item-links">
                            <a href="#">Estimated Arrival Date: <?= $ead ?></a>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-xs-12" style="padding-top: 40px; text-align: center">
            ...
            <a href="<?= base_url() ?>cars/all"><button type="button" class="btn m-btn">View All Cars<span class="fa fa-angle-right"></span></button></a>
                        </div>
    </div>
    </div>
</section><!--b-featured-->
        ...
        <div class="row">
            <div class="col-md-5 col-md-offset-2 col-sm-6 col-xs-12">
                <div class="b-welcome__text wow fadeInLeft" data-wow-delay="0.3s" data-wow-offset="100">
                    <h2>NIGERIA'S LARGEST CAR IMPORT COMPANY</h2>
                    <h3>WELCOME TO TOKUNBOCARS.NG</h3>
                    <p>Tokunbo Cars Nigeria a brand of CARSNOWNOW LIMITED which offers the most flexible, reliable and affordable alternative for purchasing a “Used” car from the United States, We have carefully created a DIY(do it yourself) system that allows you buy cars of your choice at extremely affordable rates. the system hopes to eradicate the activities of rogue car dealers and agent who are usually out to rip you off.</p>
                    <ul>
                        ...
                        <li><span class="fa fa-check"></span>All cars will be landing in Lagos port (TIN CAN) to eradicate fear of fake customs paper</li>
                    </ul>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-6 col-sm-10 col-sm-offset-1 col-md-offset-0 col-xs-12">
                <div class="b-asks__first wow zoomInLeft" data-wow-delay="0.3s" data-wow-offset="100">
                    ...
                    <div class="b-asks__first-info">
                        <h2>Earn N50,000 to N200,000 Monthly</h2>
                        <p>Become a Partner with us and earn as mush as N200,000 every month</p>
                    </div>
                    <div class="b-asks__first-arrow">
                        <a href="<?= base_url() ?>partner"><span class="fa fa-angle-right"></span></a>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-sm-10 col-sm-offset-1 col-xs-12 col-md-offset-0">
                <div class="b-asks__first m-second wow zoomInRight" data-wow-delay="0.3s" data-wow-offset="100">
                    ...
                    <div class="b-asks__first-info">
                        <h2>DO YOU NEED ASSISTANCE WITH SHIPPING FROM THE U.S?</h2>
                        <p>Search Our Inventory With Thousands Of Cars  And More 
                            Cars Are Added On A Daily Basis</p>
                    </div>
                    <div class="b-asks__first-arrow">
                        <a href="<?= base_url() ?>buy_now"><span class="fa fa-angle-right"></span></a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-sm-3 col-xs-6">
                        <div class="b-count__item">
                            ...
                            <div class="chart" data-percent="<?= $avail + 71 ?>">
                                <h2  class="percent"><?= $avail + 71 ?></h2>
                            </div>
                            <h5>Cars in stock</h5>
                        </div>
                    </div>
                    <div class="col-sm-3 col-xs-6">
                        <div class="b-count__item">
                            ...
                            <div class="chart" data-percent="<?= $sold + 111 ?>">
                                <h2  class="percent"><?= $sold + 111 ?></h2>
                            </div>
                            <h5>Cars Sold</h5>
                        </div>
                    </div>
                    <div class="col-sm-3 col-xs-6">
                        <div class="b-count__item">
                            ...
                            <div class="chart" data-percent="<?= $users + 312 ?>">
                                <h2  class="percent"><?= $users + 312 ?></h2>
                            </div>
                    ...
                    <div class="col-sm-3 col-xs-6">
                        <div class="b-count__item j-last">
                            ...
                            <div class="chart" data-percent="<?= $dealers + 44 ?>">
                                <h2  class="percent"><?= $dealers + 44 ?></h2>
                            </div>
                            <h5>AWESOME PARTNERS</h5>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row wow zoomInLeft" data-wow-delay="0.3s" data-wow-offset="100">
            ...
            <div class="col-xs-8">
                <div class="b-contact__form">
                    <p>WE SEND CHEAPEST DEALS TO OUR SUBSCRIBED USERS EVERY WEEK. ITS FREE SO SUBSCRIBE TODAY!</p>
